...
typedef int (*cb_extflat_hiervisitsubcircuits_t)(Use *use, const HierName *hierName, bool is_top);
extern int EFVisitSubcircuits(const cb_extflat_hiervisitsubcircuits_t subProc, ClientData unused);
